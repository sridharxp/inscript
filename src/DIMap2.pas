...
const
// Devanagari Inscript
UDkee: array [0..92] of ansistring =(
{ Vowels}
'd',      'e',      'f',      'r',    'g',      't',      'z',      's',    'w',   '|', '`',
'a',      'q',      'X',     'x',   '_',
{ Consonants}
...
UDFee: array [0..371] of integer =(
{ Vowels}
  $905,0,0,0,  $906,0,0,0,  $907,0,0,0,  $908,0,0,0,  $909,0,0,0,  $90A,0,0,0,  $90E,0,0,0,  $90F,0,0,0,  $910,0,0,0,
//  CANDRA O
  $911,0,0,0,
...
{ Deva Nagari}
  ...
  $91C,$94D,$91E,0,    $930,$94D,0,0,    $924,$94D,$930,0,    $915,$94D,$937,0,    $936,$94D,$930,0,
  //$936,$94D,$930,$940,
  $964,0,0,0,
{ Numerals}
